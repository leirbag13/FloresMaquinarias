...
<body>
    <div id="global">
        ...
        <div id="contenido">
            ...
            <h1>Edici&oacute;n de Servicios</h1>
           <div id="categorias">
               <a class="mas" href="../controller/insertServicios.php">AGREGAR<img class="mas" border="0" src="../images/mas.png" alt="Agregar"/></a>
               <br/>
               <br/>
                ...
                <table border="1">
                  ...
                  ?>
                    <tr>
                        ...
                        <td aling="center"> <a href="editarServicios.php?id=<?php echo $vernov[$i]['id'];?>"><img border="0" src="../images/editar.png" alt="Editar"/></a></td>
                        <td aling="center"><a href="deleteServicios.php?id=<?php echo $vernov[$i]['id'];?>"><img border="0" src="../images/eliminar.png" alt="Eliminar"/></a></td>
                    </tr>
