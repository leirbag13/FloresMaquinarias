...
class Inicio
{
    ...
    function insertInicio($box_imagen, $imagen1, $imagen2, $imagen3)
    
    {
        $this->box_imagen = $box_imagen;
        $this->imagen1 = $imagen1;
        $this->imagen2 = $imagen2;
        $this->imagen3 = $imagen3;

        $query = "insert into inicio " .
                "values (null,'$this->box_imagen', '$this->imagen1','$this->imagen2','$this->imagen3')";
    ...
    function updateInicio($id,$box_imagen, $imagen1, $imagen2, $imagen3)
    {
        $this->box_imagen = $box_imagen;
        $this->imagen1 = $imagen1;
        $this->imagen2 = $imagen2;
