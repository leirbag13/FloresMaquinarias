           ...
           <div id="categorias">
               <form action="" method="POST" enctype="multipart/form-data">
                  <table border="0">
                        ...
                        <tr>
                            <td><b>Texto</b></td>
                            <td><textarea rows="10" cols="50" name="titulo"><?php  echo $ver[0]["description"]?></textarea><span class="error">*</span></td>
                        </tr>
                        ...
                        <tr>
                           ...
                           <td> <input name="update" type="hidden" value="updateRubro"/></td>
                        </tr>
