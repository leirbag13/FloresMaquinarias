           ...
           <div id="categorias">
               <form action="" method="POST" enctype="multipart/form-data">
                  <table border="0">
                        ...
                        <tr>
                            <td><b>autor</b></td>
                            <td><input type="text" name="autor" value="<?php  echo $vernot[0]["autor"]?>"/></td>
                        </tr>
                        ...
                        <tr>
                            <td><b>fuente</b></td>
                            <td><input type="text" name="fuente"  value="<?php  echo $vernot[0]["fuente"]?>"/></td>
                        </tr>
                        ...
                        <tr>
                            <td><b>Imagen2</b></td>
                            <td>
                                <input type="text" name="imagennot2old" value="<?php  echo $vernot[0]["imagen2"]?>"/>
                        ...
                        <tr>
                            ...
                            {
                            ?>
                            <td><img width="200" height="200" src="../../upload-images/<?php echo $vernot[0]["imagen2"] ?>"/></td>
                            <?php
                            }
                            ?>
                        ...
                        <tr>
                            <td><b>Imagen3</b></td>
                            <td>
                                <input type="text" name="imagennot3old" value="<?php  echo $vernot[0]["imagen3"]?>"/>
                        ...
                        <tr>
                            ...
                            {
                            ?>
                            <td><img width="200" height="200" src="../../upload-images/<?php echo $vernot[0]["imagen3"] ?>"/></td>
                            <?php
                            }
                            ?>
