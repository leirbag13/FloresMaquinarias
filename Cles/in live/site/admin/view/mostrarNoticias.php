                ...
                <table border="1">
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?php echo $vernot[$i]["fecha"] ;?></td>
                        <td><?php echo $vernot[$i]["autor"] ;?></td>
                        <td><?php echo $vernot[$i]["fuente"] ;?></td>
                        ...
                        {
                        ?>
                        <td><img width="54" height="55" src="../../upload-images/<?php echo $vernot[$i]["imagen2"] ;?>"/></td>
                        <?php
                        }
                        ...
                        {
                        ?>
                             <td><?php echo $vernot[$i]["imagen2"] ;?></td>
                        <?php
                        }
                        ?>
                       ...
                       <!--mostrar si hay imagen 3-->
                        ...
                        {
                        ?>
                        <td><img width="54" height="55" src="../../upload-images/<?php echo $vernot[$i]["imagen3"] ;?>"/></td>
                        <?php
                        }
                        ...
                        {
                        ?>
                             <td><?php echo $vernot[$i]["imagen3"] ;?></td>
                        <?php
                        }
                        ?>
