...
<body>
    <div id="global">
        ...
        <div id="contenido">
            ...
            <h1>Edici&oacute;n de Rubro</h1>
           <div id="categorias">
               <a class="mas" href="../controller/insertRubro.php">AGREGAR<img class="mas" border="0" src="../images/mas.png" alt="Agregar"/></a>
               <br/>
               <br/>
                ...
                <table border="1">
                  ...
                  ?>
                    <tr>
                        <td><?php echo $ver[$i]["description"] ;?></td>
                        ...
                        <td aling="center"> <a href="editarRubro.php?id=<?php echo $ver[$i]['id'];?>"><img border="0" src="../images/editar.png" alt="Editar"/></a></td>
                        <td aling="center"><a href="deleteRubro.php?id=<?php echo $ver[$i]['id'];?>"><img border="0" src="../images/eliminar.png" alt="Eliminar"/></a></td>
                    </tr>
