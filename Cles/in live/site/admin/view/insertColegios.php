...
<body>
    <div id="global">
        ...
        <div id="contenido">
          ...
          <h1>Ingreso de nuevo Colegio</h1>
           ...
           <div id="categorias">
               <form action="" method="POST" enctype="multipart/form-data">
                  <table border="0">
                        ...
                        <tr>
                            <td><b>Colegio</b></td>
                            <td><input type="text" name="colegio"/></td>
                        </tr>
                        ...
                        <tr>
                            <td><b>Imagen4</b></td>
                            <td><input type="file" name="imagennot4"/></td>
                        </tr>
                        ...
                        <tr>
                            <td><b>Imagen5</b></td>
                            <td><input type="file" name="imagennot5"/></td>
                        </tr>
                        
                        <tr>
                            <td> <a href="javascript:history.back(1)">Volver Atr&aacute;s</a></td>
                           <td> <input type="submit" value="Ingresar"/></td>
                           <td> <input name="insert" type="hidden" value="insertColegio"/></td>
                        </tr>
