...
<div id="botonera">
    ...
    <div class="unBoton" ><a href="productos.php" style="font-style:italic; color:#00CD34; line-height:40px;">PRODUCTOS</a></div>
    <div class="unBoton"><a href="../controller/nosotros.php">NOSOTROS</a></div>
    <div class="unBoton"><a href="/">INICIO</a></div>
</div>
<div id="contenedor">
	<div class="colProductos"><img src="../img/imgProductos01.jpg"/></div>
    <div class="colProductos"><img src="../img/imgProductos02.jpg"/></div>
    <div class="colProductos"><img src="../img/imgProductos03.jpg"/></div>
</div>
<div id="btnsVarios">
	<div class="colBtnsVarios">
    	<div class="imgBtnsVarios"><img src="../img/imgBtns01.jpg"/></div>
        <div class="txtBtnsVarios"><a href="#">VIDEOS</a></div>
    </div>
    <div class="colBtnsVarios">
    	<div class="imgBtnsVarios"><img src="../img/imgBtns02.jpg"/></div>
        <div class="txtBtnsVarios"><a href="#">REDES SOCIALES</a></div>
    </div>
    <div class="colBtnsVarios">
    	<div class="imgBtnsVarios"><img src="../img/imgBtns03.jpg"/></div>
        <div class="txtBtnsVarios"><a href="#">NOTICIAS</a></div>
    </div>
</div>
