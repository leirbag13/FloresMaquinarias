...
<div id="botonera">
    ...
    <div class="unBoton"><a href="colegios.php" style="font-style:italic; color:#99FFFF; line-height:40px;">COLEGIOS</a></div>
...
<div id="contenedor">
	<div id="contenidoIzquierda" style= "background-image:url(../img/imgColegios01.jpg);" onClick="presionBoton()">
    	<ul id="btnsColegios" type="disc">
            <?php  for($i=0;$i<sizeof($ver);$i++):?>
            <li type="disc"><a href="colegios.php?id=<?php echo $ver[$i]["id"];?>"><?php echo $ver[$i]["colegio"] ;?></a></li>
            <?php endfor;?>
        </ul>
    </div>
    <?php if (empty($id)):?>
    <div id="contenidoDerecha">
        <img src="../img/<?php echo $ver[0]["image_1"] ;?>" style="width:650px; height:450px;" />
    </div>
        <?php else:?>
     <div id="contenidoDerecha">
        <img src="../img/<?php echo $verporid[0]["image_1"] ;?>" style="width:650px; height:450px;"/>
    </div>
    <?php endif;?>
    <div class="clear"></div>
</div>
