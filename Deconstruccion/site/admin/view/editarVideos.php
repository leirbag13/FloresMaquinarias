           ...
           <div id="categorias">
               <form action="" method="POST">
                  <table border="0">
                        ...
                        <tr>
                            <td><h3>titulo</h3></td>
                            <td><input type="text" name="titulo" value="<?php echo $ver[0]["titulo"]?>"/></td>

                        </tr>

                      <tr>
                            <td><h3>subtitulo</h3></td>
                            <td><input type="text" name="subtitulo" value="<?php echo $ver[0]["subtitulo"]?>"/></td>

                        </tr>

                      <tr>
                            <td><b>Descripcion</b></td>
                            <td><textarea rows="10" cols="50" name="descripcion"><?php echo $ver[0]["descripcion"]?></textarea></td>
                        </tr>
