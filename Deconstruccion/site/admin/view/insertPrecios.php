...
<!--                    <li><a href="../controller/mostrarCategorias.php">Categorias</a></li>
            ...
            <div class="item2">
                ...
                <ul>
                    ...
                    <li><a href="../controller/mostrarNovedades.php">Servicios</a></li>
               ...
               <form action="" method="POST">
                  <table border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="precio_unitario" value="$"/></td>
                        </tr>

                        <tr><td></td></tr>
                        <tr>
                            <td><b>cont_display</b></td>
                            <td><input type="text" name="cont_display"/></td>
                        </tr>

                        <tr><td></td></tr>
                        <tr>
                            <td><b>precio_display</b></td>
                            <td><input type="text" name="precio_display" value="$"/></td>
                        </tr>

                        <tr><td></td></tr>
                        <tr>
                            <td><b>cont_del_bulto</b></td>
                            <td><input type="text" name="cont_del_bulto"/></td>
                        </tr>

                        <tr><td></td></tr>
                        <tr>
                            <td><b>precio_del_bulto</b></td>
                            <td><input type="text" name="precio_del_bulto" value="$"/></td>
                        </tr>

                        <tr><td></td></tr>
                        <tr>
                            <td><b>sugerido_al_publico</b></td>
                            <td><input type="text" name="sugerido_al_publico" value="$"/></td>
                        </tr>
                        ...
                        <tr>
                           ...
                           <td> <input name="insert" type="hidden" value="insertpre"/></td>
                        </tr>
