...
class Mysql
	{
		...
		private $error = array();
         //creada en fuegos que me dio matias $host = 'localhost', $user = 'fuegos_estelar', $pass = 'estelar', $database='fuegos_estelar'
		public function Mysql($host = 'localhost', $user = 'porquequ_fuegos', $pass = 'AngelNEGRO33975932', $database='porquequ_fuegos') //construct
		{
