...
class Producto
{
    ...
    function mostrarPorcatProducto($cat)
    {
        $contactos = array();
        $query="select * from productos where categoria ='$cat' LIMIT 1" ;
        //echo $query;
        $resultado=$this->DB->Query($query);
        if(! $resultado)
        {
    ...
    function mostrarPoritemProducto($item)
    {
        $contactos = array();
        $query="select * from productos where item ='$item'" ;
        //echo $query;
        $resultado=$this->DB->Query($query);
        if(! $resultado)
        {
