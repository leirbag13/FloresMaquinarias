                ...
                <table border="1">
                  ...
                  ?>
                    <tr>
                        ...
                        {
                        ?>
                        <td><img width="54" height="55" src="../../upload-images/<?php echo $vernov[$i]["imagen2"] ;?>"/></td>
                        <?php
                        }
                        ...
                        {
                        ?>
                             <td><?php echo $vernov[$i]["imagen2"] ;?></td>
                        <?php
                        }
                        ?>
                       ...
                       <!--mostrar si hay imagen 3-->
                        ...
                        {
                        ?>
                        <td><img width="54" height="55" src="../../upload-images/<?php echo $vernov[$i]["imagen3"] ;?>"/></td>
                        <?php
                        }
                        ...
                        {
                        ?>
                             <td><?php echo $vernov[$i]["imagen3"] ;?></td>
                        <?php
                        }
                        ?>
